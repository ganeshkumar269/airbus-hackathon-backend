...
const {registerUser, loginUser, getKeywords, addKeywords, addAnnouncement,allAnnouncements,handleAddQna,usercountdetails,averagecountdetails,averagetimedetails} = require('../controllers/admin.js')
...
router.get('/announcement', verifyTokenMiddleware, allAnnouncements)
